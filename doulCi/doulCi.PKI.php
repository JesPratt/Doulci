...
include ( PHP_SEC_LIB . 'Crypt/RSA.php' );
	...
	$AccountTokenSignatureCheck = Check_Signature ( $AccountTokenCertificate, $AccountTokenSignature, $AccountToken );
	...
	//$iPhoneDeviceCA->setSignatureMode ( CRYPT_RSA_SIGNATURE_PKCS1 );
	...
	//$iPhoneDeviceCA_x509->setSignatureMode ( CRYPT_RSA_SIGNATURE_PKCS1 );
	...
	$Message .= "Apple Activaton Certificate PRODUCTION : " . "\n" . $iPhoneActivationOrig . "\n";
	$Message .= "Apple Activaton Certificate PublicKey, Apple Inc. : " . "\n" . $iPhoneActivationOrigPublicKey . "\n";
	...
	$Message .= "Apple Device Certificate PRODUCTION : " . "\n" . $iPhoneDeviceCAOrig . "\n";
	$Message .= "Apple Device Certificate PublicKey, Apple Inc. : " . "\n" . $iPhoneDeviceCAOrigPublicKey . "\n";
	...
	//$iPhoneDeviceCANew_x509->setSignatureMode ( CRYPT_RSA_SIGNATURE_PKCS1 );
...
LlRnlBF5VKlYlTyiQRTsfkSUKmDZzHobxR0c/uDXy5ba";
	file_put_contents ( $FairplayPublicFile, base64_decode($pv) );
